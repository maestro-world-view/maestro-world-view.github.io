(function(){
 ...
 bar.innerHTML='<div class="mw-head-line mw-head-line-1"><a class="mw-live-brand" href="index.html"><img src="logo.png" alt="Maestro World View"><div class="mw-logo"><span>MAESTRO WORLD VIEW</span></div></a><div class="mw-head-actions"><div class="mw-focus">'+(place?'FOCUS: '+place.toUpperCase():'GLOBAL INTELLIGENCE')+'</div>'+(isHome?'':'<a class="mw-header-home" href="index.html">HOME</a>')+'</div></div><div class="mw-head-line mw-head-line-2"><div class="mw-byline"><em>Brought to you by Maestro World View</em></div><div class="mw-status">● LIVE · 5 MIN</div></div>';
